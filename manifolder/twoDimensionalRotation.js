function twoDimensionalRotation(angle) {
    this.angle = angle;
...
twoDimensionalRotation.prototype.transform = function (point) {
    var newPoint = {};
...
twoDimensionalRotation.prototype.transformManifold = function (manifold) {
